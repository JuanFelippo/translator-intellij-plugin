...
public class TranslationBalloon implements TranslationMVP.View {
    ...
    private com.intellij.openapi.ui.popup.Balloon myBalloon;
    ...
    public void showAndQuery(@NotNull String queryText) {
        ...
        myBalloon.show(JBPopupFactory.getInstance().guessBestPopupLocation(editor), com.intellij.openapi.ui.popup.Balloon.Position.below);
    ...
    @Override
    public void showResult(@NotNull String query, @NotNull String result) {
        ...
        final Balloon balloon = (Balloon) buildBalloon().createBalloon();
        RelativePoint showPoint = JBPopupFactory.getInstance().guessBestPopupLocation(editor);
        createPinButton(balloon, showPoint);
        balloon.show(showPoint, com.intellij.openapi.ui.popup.Balloon.Position.below);
    ...
    private void createPinButton(final Balloon balloon, final RelativePoint showPoint) {
        balloon.setActionProvider(new Balloon.ActionProvider() {
            private Balloon.ActionButton myPinButton;

            @NotNull
            public List<Balloon.ActionButton> createActions() {
