...
public class BalloonBuilder implements com.intellij.openapi.ui.popup.BalloonBuilder {
    ...
    private final Map<Disposable, List<com.intellij.openapi.ui.popup.Balloon>> myStorage = new WeakHashMap<>();
    ...
    private com.intellij.openapi.ui.popup.Balloon.Layer myLayer;
    ...
    @NotNull
    @Override
    public BalloonBuilder setLayer(com.intellij.openapi.ui.popup.Balloon.Layer layer) {
        myLayer = layer;
        return this;
    }
    ...
    @NotNull
    @Override
    public com.intellij.openapi.ui.popup.Balloon createBalloon() {
        final Balloon result = new Balloon(
        ...
        if (myAnchor != null) {
            List<com.intellij.openapi.ui.popup.Balloon> balloons = myStorage.get(myAnchor);
            if (balloons == null) {
                myStorage.put(myAnchor, balloons = new ArrayList<>());
                Disposer.register(myAnchor, new Disposable() {
                    @Override
                    public void dispose() {
                        List<com.intellij.openapi.ui.popup.Balloon> toDispose = myStorage.remove(myAnchor);
                        if (toDispose != null) {
                            for (com.intellij.openapi.ui.popup.Balloon balloon : toDispose) {
